...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=terrainmap&box=-122.307346,42.028395,-122.404093,41.956530
...
-----------
  ...
  * terrainmap Height Map (ASTER 30m).png
  ...
  * terrainmap Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * terrainmap Height Map (SRTM3 v4.1).png
  ...
  * terrainmap Height Map (SRTM30 Plus).png
  ...
  * terrainmap Height Map (USGS NED 10m).png
...
These heightmaps were adjusted such that 703m (actual) is equal to 40m in
